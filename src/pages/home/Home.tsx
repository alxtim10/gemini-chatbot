...
const Home = () => {
    ...
    return (
        <section className={`${isFirstLoad ? 'justify-center' : 'justify-start'} w-full flex flex-col items-center min-h-screen`}>
            {isFirstLoad && (
            ...
            <div ref={chatEndRef} />
            <div className={`${isFirstLoad ? 'mt-10' : 'fixed bottom-0 left-0 pb-10'} bg-[#212121] flex flex-col items-center justify-center gap-6 w-full px-8`}>
                <div
